...
class ResPartner(models.Model):
    ...
    subscription_list_ids = fields.Many2many('mailing.contact.subscription', compute="_compute_mailchimp_subscription_list_ids", groups='mass_mailing.group_mass_mailing_user', string='Subscription Information')
                    ...
                    try:
                        ...
                        if 'from_cron' in self.env.context:
                            activity = self.env['mail.activity'].sudo().create({
                                ...
                                'note': _('Problem found during auto export contact to MailChimp : {}'.format(e)),
