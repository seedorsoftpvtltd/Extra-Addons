...
class CustomerPortal(CustomerPortal):
    ...
    def my_helpdesk_tickets(self, page=1, date_begin=None, date_end=None, sortby=None, search=None, search_in='content', **kw):
        ...
        return request.render("website_axis_helpdesk.portal_helpdesk_ticket", values)
    ...
    def tickets_followup(self, ticket_id=None, access_token=None, **kw):
        ...
        return request.render("website_axis_helpdesk.tickets_followup", values)
    ...
    def index_submit(self, access_token=None, **post):
        ticket = request.env['helpdesk.ticket'].sudo().search([('id','=',post.get('id'))])
        ...
        return request.render('website_axis_helpdesk.rating_submit')