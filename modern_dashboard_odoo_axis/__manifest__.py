# -*- coding: utf-8 -*-
{
    'name': "Modern Odoo Dashboards - Odoo POS Dashboard, CRM Dashboard, Inventory Dashboard, Sales Dashboard, Account Dashboard",

   'summary': """
       Dashboard - POS dashboard in odoo, CRM dashboard in odoo, inventory dashboard in odoo, sales dashboard 
