odoo.define("ks_curved_backend_theme_warehouse.ks_appsmenu", function(require) {
    "use strict";
...
//            const hblogistics = await this._rpc({
//                route: "/ks_curved_theme/hblogistics",
//                params: { hb_icons: this._apps },
//
//            });
//            this._hblogistics = hblogistics;
...
//        },
        ...
        _ksSearchMenusList: function() {
            ...
            this.$search_results.html(
                QWeb.render("ks_curved_backend_theme_warehouse.ks_search_menu_items", {
        ...
        _ksAddToFav: function(ev) {
            ...
            $(ev.currentTarget)
                .find("img")
                .attr("src", "ks_curved_backend_theme_warehouse/static/src/images/star.svg");
        ...
        _ksRemFromFav: function(ev) {
            ...
            $(ev.currentTarget)
                .find("img")
                .attr("src", "ks_curved_backend_theme_warehouse/static/src/images/fav_ic.svg");
