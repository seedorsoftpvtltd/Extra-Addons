odoo.define('ks_curved_backend_theme_warehouse.ControlPanel', function (require) {
"use strict";
...
odoo.define("ks_curved_backend_theme_warehouse.AbstractController", function (require) {
  "use strict";
