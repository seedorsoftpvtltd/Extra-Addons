odoo.define('hrms_dashboard_people.Dashboard', function (require) {
"use strict";
...
var HrDashboard = AbstractAction.extend({
    ...
    cssLibs: [
        '/hrms_dashboard_people/static/src/css/lib/nv.d3.css'
    ],
    jsLibs: [
        '/hrms_dashboard_people/static/src/js/lib/d3.min.js'
    ],
    events: {
