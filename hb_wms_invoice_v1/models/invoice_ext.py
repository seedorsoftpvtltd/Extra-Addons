...
class Partnerforminherit(models.Model):
    ...
    def create_inv_invoice_core_consolidated(self):
        ...
        for partner in self:
            ...
            inven = self.env['product.summary'].search(
                [('partner_id', '=', partner.id), ('storage_product', '=', False)])
    ...
    def create_inv_invoice_core_seperate(self):
        invoices = []
        for partner in self:
            s = partner.last_inv_date
            e = partner.inv_end_date
