odoo.define('modern_dashboard_odoo_axis_finance.InventoryDashboard',  function (require) {
"use strict";
...
var InventoryDashboardACtion = AbstractAction.extend({
    ...
    cssLibs: [
        '/modern_dashboard_odoo_axis_finance/static/src/scss/lib/nv.d3.css'
    ],
    jsLibs: [
        '/modern_dashboard_odoo_axis_finance/static/src/js/lib/d3.min.js',
        '/modern_dashboard_odoo_axis_finance/static/src/js/lib/charts/chart.js',
