...
odoo.define('backend_theme_web_responsive_odoo13', function (require) {
    'use strict';
    ...
    AppsMenu.include({
        ...
        _searchMenus: function () {
            ...
            this.$search_results.html(
                core.qweb.render(
                    "backend_theme_web_responsive_odoo13.MenuSearchResults",
                    {
                        results: results,
                        widget: this,
                    }
    ...
    FormRenderer.include({
        ...
        _renderHeaderButtons: function () {
            ...
            const $dropdown = $(core.qweb.render(
                'backend_theme_web_responsive_odoo13.MenuStatusbarButtons'
            ));
    ...
    ActionManager.include({
        ...
        */
        _hideMenusByAction: function (action) {
            ...
            $(menu_sections_mobile).has(uniq_sel).removeClass('show');
        },
