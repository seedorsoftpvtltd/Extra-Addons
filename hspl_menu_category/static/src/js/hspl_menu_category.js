...
AppsMenu.include({
      ...
      init: function (parent, menuData,ctg_data) {
            ...
            for (var c in this._apps) {
                this._apps[c].category_id =
                    menuData.children[c].category_id;
            }
...
Menu.include({
        ...
        start: function () {
                ...
                // Apps Menu
                this._appsMenu = new AppsMenu(self, this.menu_data, this.ctg_data);
                ...
                var systrayMenuProm = this.systray_menu.attachTo(this.$('.o_menu_systray')).then(function() {
                    ...
                    maxWidth: function () {
                        return self.$el.width() - (self.$menu_apps.outerWidth(true) +
                        self.$menu_brand_placeholder.outerWidth(true) + self.systray_menu.$el.outerWidth(true));
                    },
                    sizeClass: 'SM',
                    });
                });
