...
class InvoiceTransferDone(models.Model):
    ...
    def invoice_whatsapp(self):
        ...
        if not record_phone[0] == "+":
            ...
            return {'type': 'ir.actions.act_window',
                    ...
                    'res_model': 'whatsapp.wizard.invoice',
                    'target': 'new',
                    'view_mode': 'form',
                    'view_type': 'form',
                    'context': {
    ...
    def send_direct_message(self):
        ...
        if not record_phone[0] == "+":
            ...
            self.chatter_msgdirect_invoice(custom_msg)
            return {
    ...
    def chatter_msgdirect_invoice(self,custom_msg):

            self.message_post(body=custom_msg,
                                  subject="Invoice Whatsapp Direct Message")
