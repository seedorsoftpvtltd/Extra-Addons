...
class PurchaseOrderModule(models.Model):
    ...
    def purchase_whatsapp(self):
        ...
        if not record_phone[0] == "+":
            ...
            return {'type': 'ir.actions.act_window',
                    ...
                    'res_model': 'whatsapp.wizard.purchase',
                    'target': 'new',
                    'view_mode': 'form',
                    'view_type': 'form',
                    'context': {
    ...
    def send_direct_message(self):
        ...
        if not record_phone[0] == "+":
            ...
            self.chatter_msgdirect_purchase(custom_msg)
            return {
    ...
    def chatter_msgdirect_purchase(self,custom_msg):

            self.message_post(body=custom_msg,
                                  subject="Purchase Whatsapp Direct Message")        
