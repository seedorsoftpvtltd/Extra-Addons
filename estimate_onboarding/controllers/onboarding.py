...
class LeavesController(http.Controller):
    ...
    @http.route('/estimate/estimate_dashboard_onboarding', auth='user', type='json')
    def leaves_dashboard_onboarding(self):
        ...
        #
        return {
            'html': request.env.ref('estimate_onboarding.estimate_onboarding_onboarding_panel').render({
                'company': company,
