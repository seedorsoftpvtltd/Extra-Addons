...
class AccountPayments(models.Model):
    ...
    manual_currency_exchange_rate = fields.Float(string='Manual Currency Exchange Rate',digits=(12,5))
    ...
    def default_get(self, fields):
        ...
        # for rec in move_id:
        #     result.update({
        #         'apply_manual_currency_exchange':rec.apply_manual_currency_exchange,
