odoo.define('tis_tally_bs_and_pl.financial_reports', function (require) {
    'use strict';
                ...
                try{
                    ...
                    self._rpc({
                        ...
                        self.$('.table_view_dfr').html(QWeb.render('dfr_table', {
                                            ...
                                            balance_sheet_lines : datas['balance_sheet_lines'],
    ...
    print_pdf: function(e) {
            ...
            self._rpc({
                ...
                var action = {
                    ...
                    'report_name': 'tis_tally_bs_and_pl.balance_sheet',
                    'report_file': 'tis_tally_bs_and_pl.balance_sheet',
                    'data': {
                        'report_data': data,
            ...
            self._rpc({
                ...
                var action = {
                    ...
                    'data': {
                         ...
                         'report_name': action_title,
                         'dfr_data': JSON.stringify(data['balance_sheet_lines']),
                    },
                };
//                return self.do_action(action);
...
//            filter_data_selected.analytic_tag_ids = analytic_tag_ids
    ...
    core.action_registry.add("dynamic_finance_report", ProfitAndLoss);
