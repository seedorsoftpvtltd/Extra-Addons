            ...
            if picking_id.picking_type_id.code != 'internal':
                ...
                for temp in agreement_id.charge_lines_new:
                    ...
                    if temp.charge_type == 'storage' and temp.storage_type == stoarge_type:
                        ...
                        if int(dur) >= temp.fromm and temp.to != False:
                            if int(dur) >= temp.to:
                                print('startttttttttttttttttttttttttt',abs(temp.to - temp.fromm))
                                ...
                                print('startttttttttttttttttttttttttt=======================================', abs(dur - temp.fromm))
                                # raise UserError(_(meas))
