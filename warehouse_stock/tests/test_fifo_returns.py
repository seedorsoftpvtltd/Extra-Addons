...
class TestFifoReturns(Testwarehouse):

    def test_fifo_returns(self):
        """Test to create product and warehouse order to test the FIFO returns of the product"""
        ...
        product_fiforet_icecream.categ_id.property_stock_account_input_categ_id = self.ref('warehouse.o_expense')
        product_fiforet_icecream.categ_id.property_stock_account_output_categ_id = self.ref('warehouse.o_income')
        ...
        # Create a draft warehouse Order for second shipment for 30kg at 80€/kg
        ...
        # Return the goods of warehouse order 2
        picking = warehouse_order_2.picking_ids[0]
        ...
        #  After the return only 10 of the second warehouse order should still be in stock as it applies fifo on the return too
