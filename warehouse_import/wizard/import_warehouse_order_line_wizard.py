...
class ImportwarehouseOrderLine(models.TransientModel):
    _name = "import.warehouse.order.line"
    _description = 'import warehouse order line'
    ...
    def import_warehouse_order_line(self):
        if self.file_option == 'csv':
            ...
            warehouse_order = self.env[model].browse(self.env.context.get('active_id'))
            ...
            for line in csv_reader:
                ...
                if line.get('SecUom'):
                    secuom = self.env['uom.uom'].search([('name', '=', line.get('SecUom'))])
                            ...
                            warehouse_order.write({
                                'order_line': [
                                    (0, 0, {
                                        ...
                                        'sh_sec_uom': secuom.id if secuom else False,
                                    }),
                                ]
                            ...
                            warehouse_order.write({
                                'order_line': [
                                    (0, 0, {
                                        ...
                                        'date_planned': datetime.datetime.now(),
                                        'order_id': warehouse_order,
                                        'sh_sec_uom': rec.sh_secondary_uom.id if line.get('SecUom') else False,
            ...
            for row in xls_reader:
                ...
                if line.get('Tax'):
                    ...
                    print(vendor_tax, vendor_tax.name)
