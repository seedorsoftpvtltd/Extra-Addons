# -*- coding: utf-8 -*-
{
    'name': "Import Sales Orders, warehouse Orders, POS Orders, Chart Account data, Invoice, Stock Inventory, Products, Product attributes, Bill of material(BOM), Payments, Bank Statement, All Entry, Order Picking, Customers, Stocks, Account charts, Sales Pricelist, Supplier,Journal, journal entry using EXCEL or CSV",
    'category': 'Import Record',
    'version': '13.1.4',
    'description' : "Import data in odoo, import Sale Orders. import warehouse Orders, Import POS Orders, Chart Account data, warehouse, Import Product, Invoice, Stock Inventory Import, Bill of material(BOM), Payment, Bank Statement, All Entry, Order Picking, Product, Customer, Stock, Account charts, Sales Pricelist, Supplier, Journal data import, journal entry all data import in odoo using EXCEL or CSV",
    'summary': "Data Import bridge for import Sales Orders import warehouse Orders import POS Orders import Chart Account data import warehouse import Product import Invoice import Stock Inventory import Bill of material(BOM) import Payment import Bank Statement import All Entry import Order Picking import Products import Customer import Stock import Account charts import Sales Pricelist import Supplier import Journal data import journal entry import Supplier import sale Orders import Bulk Pricelist import product pricelist Import Sale Pricelist import vendor pricelist import inventory Odoo import Data All in one import all import data in odoo using EXCEL or CSV",
    'depends': ['base', 'warehouse','import_bridge_axis'],
    'data': [
        ...
        'wizard/import_warehouse_order_wizard_view.xml',
        'wizard/import_warehouse_order_line_wizard_view.xml',
