...
//self.filter_data.date_from_tmp = self.filter_data.date_from;
//self.filter_data.date_to_tmp = self.filter_data.as_on_date;
//self.filter_data.date_from = field_utils.format.date(field_utils.parse.date(self.filter_data.date_from, {}, {isUTC: true}));
//self.filter_data.date_to = field_utils.format.date(field_utils.parse.date(self.filter_data.as_on_date, {}, {isUTC: true}));
self.filter_data.as_on_date = field_utils.format.date(field_utils.parse.date(self.filter_data.as_on_date, {}, {isUTC: true}));
if(initial_render){
...
domains.partner_ids = partner_ids
if($(".date_filter-multiple").select2('data').length === 1){
