    ...
    def _prepare_invoice_line(self, account_lines, invoice):
        ...
        for account_line in account_lines:
            ...
            if account_line.task_id and account_line.task_id.product_id_construction:
                ...
                account = account_line.task_id.product_id_construction.property_account_income_id or account_line.task_id.product_id_construction.categ_id.property_account_income_categ_id
                ...
                account = account_line.project_id.product_id_construction.property_account_income_id or account_line.project_id.product_id_construction.categ_id.property_account_income_categ_id
            else:
                product_id_helpdesk = account_line.project_id.partner_id.product_id_construction.id
                account = account_line.project_id.partner_id.product_id_construction.property_account_income_id or account_line.project_id.partner_id.product_id_construction.categ_id.property_account_income_categ_id
            ...
            if not account:
                raise UserError(_('Please configure Default Income account for Product.'))
            res = {
                    'name': _(name),
