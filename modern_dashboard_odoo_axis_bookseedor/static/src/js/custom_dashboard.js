odoo.define('modern_dashboard_odoo_axis_bookseedor.dashboard_view',  function (require) {
"use strict";
	...
	var CustomDashboard = AbstractAction.extend({
		...
		jsLibs: [
	        '/modern_dashboard_odoo_axis_bookseedor/static/src/js/lib/gridstack.all.js',
