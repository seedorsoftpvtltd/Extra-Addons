odoo.define('sales_contract_seperate_module.MyCustomAction',  function (require) {
"use strict";
...
var MyCustomAction = AbstractAction.extend({
    ...
    cssLibs: [
        '/sales_contract_seperate_module/static/src/css/nv.d3.css'
    ],
    jsLibs: [
        '/sales_contract_seperate_module/static/src/js/Chart.js',
    ],
    events: {
