# -*- coding: utf-8 -*-
{
    ...
    'summary': """
        The robust, fully responsive Arc Backend Theme boosts your business productivity with its strikingly advanced features & functionalities. With its pixel-perfect nature, Arc helps you scale your Odoo operations most efficiently.
    """,
    'description': """
        odoo backend themes
        odoo responsive backend theme
        odoo themes
        odoo backend theme V13
        odoo 13 backend theme
        backend theme odoo
    ...
    'price': '149.0',
    'version': '13.0.1.0.0',
    'live_test_url': 'https://arctheme13.kappso.com/web/demo_login',
