...
class KsThemeGlobalConfig(models.Model):
    ...
    ks_website_title = fields.Char(string="Website Backend Title", default='Seedor')
    ks_click_edit = fields.Boolean(string="Double-click Edit", default=False)
    ...
    ks_odoo_referral = fields.Boolean(string="Show Seedor Referral", default=False)
    ...
    scope_ks_enterprise_apps = fields.Selection(string="Scope of Enterprise Apps",
                                                selection=[('User', 'User'), ('Company', 'Company'),
                                                           ('Global', 'Global')],
                                                default='User')
    scope_ks_odoo_referral = fields.Selection(string="Scope of Seedor referral",
                                              selection=[('User', 'User'), ('Company', 'Company'),
                                                         ('Global', 'Global')],
                                              default='User')
    ...
    def ks_get_config_values(self):
        ...
        :return:
        """
        ks_global_config_id = self.env.ref('ks_curved_backend_theme_warehouse_people.ks_global_config_single_rec').id
    ...
    def get_body_background(self, ks_fields):
        ...
        :return:
        """
        ks_global_config_id = self.env.ref('ks_curved_backend_theme_warehouse_people.ks_global_config_single_rec')
        ks_image_model = {
        ...
        for rec in ks_fields:
            ...
            if ks_origin_data[rec]:
                ...
                if rec == 'ks_app_drawer_background':
                    ks_drawer_font_style = self.env['ks.drawer.colors'].sudo().search(
    ...
    def ks_get_value_from_scope(self, ks_field_list):
        ks_global_origin = self.env.ref('ks_curved_backend_theme_warehouse_people.ks_global_config_single_rec')
