odoo.define("ks_curved_backend_theme_warehouse_people.FormController", function (require) {
  "use strict";
...
//    },
    ...
    _updateView: function ($newContent) {
      ...
      var temp_this = this;
      if (this.$el.children(".o_chatter.oe_chatter").length) {
        this._rpc({
    ...
    _ksOnFormviewDblClick: function (ev) {
      ...
      this._rpc({
        ...
        if (
          ...
          Session.ks_curved_backend_theme_warehouse_people_data
        ) {
