odoo.define("ks_curved_backend_theme_warehouse_people.ks_appsmenu", function(require) {
    "use strict";
    ...
    AppsMenu.include({
        ...
        willStart: async function() {
            ...
            const hbdesk = await this._rpc({
                route: "/ks_curved_theme/hbdesk",
                params: { hb_icons: this._apps },

            });
            this._hbdesk = hbdesk;

            const hbwarehouse = await this._rpc({
                route: "/ks_curved_theme/hbwarehouse",
                params: { hb_icons: this._apps },

            });
            this._hbwarehouse = hbwarehouse;

            const hbaccounts = await this._rpc({
                route: "/ks_curved_theme/hbaccounts",
                params: { hb_icons: this._apps },

            });
            this._hbaccounts = hbaccounts;

            const hbpeople = await this._rpc({
                route: "/ks_curved_theme/hbpeople",
                params: { hb_icons: this._apps },

            });
            this._hbpeople = hbpeople;

            const hbfreight = await this._rpc({
                route: "/ks_curved_theme/hbfreight",
                params: { hb_icons: this._apps },

            });
            this._hbfreight = hbfreight;
        ...
        _desk: function() {
            ...
            var apps = this._hbdesk;
            var app = this._apps;
            console.log(apps,'appshb')
            console.log(app, 'appall')
            var i,
                j,
                app_listdesk = [],
                chunk = 12;
            ...
            for (i = 0, j = apps.length; i < j; i += chunk) {
                app_listdesk.push(apps.slice(i, i + chunk));
                            console.log(app_listdesk,'applistdesk')
        ...
        _warehouse: function() {
            ...
            for (i = 0, j = apps.length; i < j; i += chunk) {
                app_listwar.push(apps.slice(i, i + chunk));
                            console.log(app_listwar,'applisthb')
        ...
        _accounts: function() {
            ...
            for (i = 0, j = apps.length; i < j; i += chunk) {
                app_listaccu.push(apps.slice(i, i + chunk));
                            console.log(app_listaccu,'applisthb')
        ...
        _people: function() {
            ...
            for (i = 0, j = apps.length; i < j; i += chunk) {
                app_listlogi.push(apps.slice(i, i + chunk));
                            console.log(app_listlogi,'applisthb')
        ...
        _freight: function() {
            ...
            for (i = 0, j = apps.length; i < j; i += chunk) {
                app_listfre.push(apps.slice(i, i + chunk));
                            console.log(app_listfre,'applisthb')
...
//        _affinity:function(){
//        return this._hbaffinity;
//        },
//        _finance:function(){
//        return this._hbfinance;
//        },
//        _people:function(){
//        return this._hbpeople;
//        },
//        _project:function(){
//        return this._hbproject;
//        },
        ...
        _ksSearchMenusList: function() {
            ...
            this.$search_results.html(
                QWeb.render("ks_curved_backend_theme_warehouse_people.ks_search_menu_items", {
        ...
        _ksAddToFav: function(ev) {
            ...
            $(ev.currentTarget)
                .find("img")
                .attr("src", "ks_curved_backend_theme_warehouse_people/static/src/images/star.svg");
        ...
        _ksRemFromFav: function(ev) {
            ...
            $(ev.currentTarget)
                .find("img")
                .attr("src", "ks_curved_backend_theme_warehouse_people/static/src/images/fav_ic.svg");
