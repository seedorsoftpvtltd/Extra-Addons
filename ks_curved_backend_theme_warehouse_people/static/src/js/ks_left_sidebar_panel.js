odoo.define(
  "ks_curved_backend_theme_warehouse_people.ks_left_sidebar_panel",
  function (require) {
    "use strict";
    ...
    var ksAppSidebar = require("ks_curved_backend_theme_warehouse_people.ks_app_sidebar");
    var ksBookmarks = require("ks_curved_backend_theme_warehouse_people.ks_bookmarks");
    ...
    Menu.include({
      ...
      willStart: function () {
        ...
        var ks_fields_data = self
          ...
          if ((self.ks_menu_bar == "Horizontal" && self.ks_favorite_bar && self.ks_favtbar_position == "Left") || (self.ks_menu_bar == "Vertical" && !self.ks_menubar_autohide))
              document.body.classList.add("ks_leftpanel_active");
          });
        return Promise.all([
