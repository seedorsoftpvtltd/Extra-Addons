...
TYPE_LISTS = ['integer', 'float', 'char', 'text', 'date', 'datetime', 'boolean']
                        ...
                        if product_find_field.ttype != 'boolean' and data[d] == 'FALSE':
                            ...
                            vals.update({
                                ...
                                field_name: datetime.strptime(
                                    data[d], '%m-%d-%Y %H:%M:%S') - timedelta(hours=5, minutes=30)
                            })
    ...
    def show_notification(self):
        notification = {
            ...
            'params': {
                ...
                'message': _('Google sheet data is successfully imported to Seedor.'),
...
class InheritIrModel(models.Model):
    ...
    change_data = fields.Boolean(string='Allow Change Data/Fields Through Google Sheet API')
