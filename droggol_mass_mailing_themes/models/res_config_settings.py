...
class ResConfigSettings(models.TransientModel):
    ...
    d_mass_mailing_theme_colors = fields.Char(string="Theme Colors", default='{"primary": "#4285f4", "success": "#00c851", "info": "#33b5e5", "warning": "#ffbb33", "danger": "#ff3547", "header": "#333333", "content": "#737373"}', config_parameter='d_mass_mailing_theme_colors')
