            ...
            this.$('.d_mail_tooltip_1').tooltip({
                ...
                title: "\
                        <div class='p-2'>\
                            ...
                            <div> • You can also use it as a button, background or text color. </div> \
                        </div> \
                    "
            });
            this.$('.d_mail_tooltip_2').tooltip({
                ...
                title: "\
                        <div class='p-2'>\
                            ...
                            <div> •  You can use them as a button, background or text color. </div> \
                        </div> \
                    "
            });
            this.$('.d_mail_tooltip_3').tooltip({
                ...
                title: "\
                        <div class='p-2'>\
                            ...
                            <div> •   Note: Dark colors are recomnded for both. </div> \
                        </div> \
                    "
            });
        }
