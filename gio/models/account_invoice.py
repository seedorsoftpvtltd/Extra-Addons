...
class AccountMove(models.Model):
    ...
    teams_id = fields.Many2one(
        'crm.team', string='GIO Team', default=_get_invoice_default_sale_team,
    ...
    def onchange_user_id(self):
        if self.invoice_user_id and self.invoice_user_id.sale_teams_id:
            self.teams_id = self.env['crm.team']._get_default_team_id(user_id=self.invoice_user_id.id, domain=[('company_id', '=', self.company_id.id)])
