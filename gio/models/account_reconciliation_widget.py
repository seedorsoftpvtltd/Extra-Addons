...
class AccountReconciliation(models.AbstractModel):
    ...
    def _get_sales_order(self, res):
        ...
        self.env['goods.issue.order'].flush(['name', 'reference', 'invoice_status', 'company_id',
        ...
        for line in res.get('lines', []):
            ...
            if so_data:
                line['goods_order_ids'] = so_data[0]
    ...
    def get_bank_statement_line_data(self, st_line_ids, excluded_ids=None):
        ...
        inject_orders = self.env['ir.config_parameter'].sudo().get_param('gio.reconciliation_with_so')
        if inject_orders != 'no':
