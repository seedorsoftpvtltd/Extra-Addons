...
class ProductProduct(models.Model):
    ...
    def _compute_sales_count(self):
        ...
        done_states = self.env['gio.report']._get_done_states()
        ...
        for group in self.env['gio.report'].read_group(domain, ['product_id', 'product_uom_qty'], ['product_id']):
    ...
    def _filter_to_unlink(self):
        ...
        lines = self.env['goods.order.line'].read_group(domain, ['product_id'], ['product_id'])
...
class ProductAttributeCustomValue(models.Model):
    ...
    sale_order_line_id = fields.Many2one('goods.order.line', string="Goods Order Line", required=True, ondelete='cascade')
