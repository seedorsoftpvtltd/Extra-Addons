...
class ResPartner(models.Model):
    ...
    goods_order_ids = fields.One2many('goods.issue.order', 'partner_id', 'Goods Order')
    ...
    def _compute_sale_order_count(self):
        ...
        sale_order_groups = self.env['goods.issue.order'].read_group(
    ...
    def can_edit_vat(self):
        ...
        if not can_edit_vat:
            return can_edit_vat
        GoodsIssueOrder = self.env['goods.issue.order']
        has_so = GoodsIssueOrder.search([
