...
class AccountAnalyticLine(models.Model):
    ...
    def _default_goods_line_domain(self):
    ...
    so_lines = fields.Many2one('goods.order.line', string='Goods Order Item', domain=lambda self: self._default_goods_line_domain())
