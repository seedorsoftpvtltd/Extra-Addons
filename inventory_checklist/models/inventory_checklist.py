...
class InventoryChecklistTemplate(models.Model):
    _name = 'inventory.checklist.template'
    _description = 'Checklist Template'

    name = fields.Char(required=True)
    code = fields.Char(string='Reference', required=True)
    note = fields.Text(string='Description')
    checklist_ids = fields.Many2many('checklist.points', 'inventory_checklist_points_template_rel', 'template_id', 'checklist_id', string='Checklists')
...
class InventoryChecklist(models.Model):
    _name = 'inventory.checklist'
    _description = 'Inventory Checklist'
...
class StockPicking(models.Model):
    ...
    checklist_ids = fields.One2many('inventory.checklist', 'picking_id', 'Checklists')
    ...
    template_id = fields.Many2one('inventory.checklist.template', 'Checklist Template')
