...
class ShProductTemplate(models.Model):
    ...
    sh_qty_in_bag = fields.Float("Quantity in Bags", compute='_compute_qty_in_bag',
                                 inverse='_set_qty_in_bag', search='_search_qty_in_bag', default=None, copy=False)
    units_on_hand = fields.Float(compute="get_units_on_hand")
    units_forecasted = fields.Float(compute="get_units_forecasted")
