/*  global Highcharts*/
odoo.define("web_lead_funnel_chart_affinity.web_lead_funnel_chart_affinity", function (require) {
    "use strict";
    ...
    var web_lead_funnel_chart_affinity = AbstractAction.extend( {
        template: "FunnelChart",
        xmlDependencies:
        ['web_lead_funnel_chart_affinity/static/src/xml/web_funnel_chart.xml'],
        start: function () {
            var self = this;
            var emp_child = [];
    ...
    core.action_registry.add("web_lead_funnel_chart_affinity.funnel",
        web_lead_funnel_chart_affinity);
