# -*- coding: utf-8 -*-
{
    'name': "Modern Odoo Dashboards - Odoo CRM Dashboard, Inventory Dashboard, Sales Dashboard(Affinity)",

   'summary': """
       Dashboard - CRM dashboard in odoo, inventory dashboard in odoo, sales dashboard 
       in odoo with chart and graphs and table view.""",
    'live_test_url': 'https://www.youtube.com/watch?v=7KnOICS9q7s&feature=youtu.be',

    'depends': ['base','sale_management','crm','stock','hr_attendance'],
