...
class AccountMove(models.Model):
    ...
    def default_get(self, fields):
        ...
        if (
            self.env.context.get("default_operation_id", False)
            ...
            res.update(
                {
                    "partner_id": operation_rec.consignee_id
                    and operation_rec.consignee_id.id
                    or operation_rec.customer_id
                    and operation_rec.customer_id.id
                    or False
                }
            )
        return res
