odoo.define('team_attendance_face_recognition.team_attendance_face_recognition', function (require) {
    "use strict";
    ...
    MyAttendances.include({
        ...
        loadLabeledImages:  function(){
            var self = this;
            return this._rpc({
                route: '/team_attendance_face_recognition/loadLabeledImages/'
        ...
        prepareFaceDetector: async function() {
            ...
            return new Promise(function(){
                ...
                base_image.src = "/team_attendance_face_recognition/static/src/img/startFaceDetect.jpg";
        ...
        update_attendance: function () {
            var self = this;
            if(session.team_attendance_face_recognition){
        ...
        getName: function(employee_id){
            ...
            prom.then(function () {
                if (employee_id !== 'unknown'){
                    self._rpc({
                        route: `/team_attendance_face_recognition/getName/${employee_id}/`
                    })
                    .then(function(result){
                        if (result){
