...
class KsThemeGlobalConfig(models.Model):
    ...
    def ks_get_config_values(self):
        ...
        :return:
        """
        ks_global_config_id = self.env.ref('ks_curved_backend_theme_seedorpeoplev1.ks_global_config_single_rec').id
    ...
    def get_body_background(self, ks_fields):
        ...
        :return:
        """
        ks_global_config_id = self.env.ref('ks_curved_backend_theme_seedorpeoplev1.ks_global_config_single_rec')
        ks_image_model = {
    ...
    def ks_get_value_from_scope(self, ks_field_list):
        ks_global_origin = self.env.ref('ks_curved_backend_theme_seedorpeoplev1.ks_global_config_single_rec')
