odoo.define("ks_curved_backend_theme_seedorpeoplev1.ks_appsmenu", function(require) {
    "use strict";
    ...
    AppsMenu.include({
        ...
        willStart: async function() {
            ...
            const hbcompensation = await this._rpc({
                route: "/ks_curved_theme/hbcompensation",
                params: { hb_icons: this._apps },

            });
            this._hbcompensation = hbcompensation;

            const hbworkforce = await this._rpc({
                route: "/ks_curved_theme/hbworkforce",
                params: { hb_icons: this._apps },

            });
            this._hbworkforce = hbworkforce;
        ...
        _compensation: function() {

            var apps = this._hbcompensation;
            var app = this._apps;
            console.log(apps,'appshb')
            console.log(app, 'appall')
            var i,
            ...
            for (i = 0, j = apps.length; i < j; i += chunk) {
                app_listcompen.push(apps.slice(i, i + chunk));
                            console.log(app_listcompen,'applisthb')

            }
            return app_listcompen;
        },

        _workforce: function() {

            var apps = this._hbworkforce;
            var app = this._apps;
            console.log(apps,'appshb')
            console.log(app, 'appall')
            var i,
            ...
            for (i = 0, j = apps.length; i < j; i += chunk) {
                app_listwork.push(apps.slice(i, i + chunk));
                            console.log(app_listwork,'applisthb')
...
//        _compensation:function(){
//        return this._hbcompensation;
//        },
//        _workforce:function(){
//        return this._hbworkforce;
//        },
//        _people:function(){
...
//        },
        ...
        _ksSearchMenusList: function() {
            ...
            this.$search_results.html(
                QWeb.render("ks_curved_backend_theme_seedorpeoplev1.ks_search_menu_items", {
        ...
        _ksAddToFav: function(ev) {
            ...
            $(ev.currentTarget)
                .find("img")
                .attr("src", "ks_curved_backend_theme_seedorpeoplev1/static/src/images/star.svg");
        ...
        _ksRemFromFav: function(ev) {
            ...
            $(ev.currentTarget)
                .find("img")
                .attr("src", "ks_curved_backend_theme_seedorpeoplev1/static/src/images/fav_ic.svg");
