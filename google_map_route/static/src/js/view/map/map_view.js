odoo.define('google_map_route.MapView', function (require) {
    'use strict';

    var BasicView = require('web.BasicView');
    var core = require('web.core');

    var MapModel = require('google_map_route.MapModel');
    var MapRenderer = require('google_map_route.MapRenderer').MapRenderer;
    var MapController = require('google_map_route.MapController');
