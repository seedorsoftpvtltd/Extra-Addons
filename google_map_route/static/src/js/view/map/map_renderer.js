odoo.define('google_map_route.MapRenderer', function (require) {
    'use strict';
    ...
    var MapRenderer = BasicRenderer.extend({
        ...
        set_property_geometry: function (params) {
            ...
            this.markers = [];
            this.iconUrl = '/google_map_route/static/src/img/markers/';
        ...
        _initMarkerCluster: function () {
            this.markerCluster = new MarkerClusterer(this.gmap, [], {
                imagePath: '/google_map_route/static/lib/markercluster/img/m',
                gridSize: 20,
                maxZoom: 17,
            });
        },
        ...
        _getIconColorPath: function (color) {
            var defaultPath = '/google_map_route/static/src/img/markers/';
