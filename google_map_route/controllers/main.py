...
class Main(http.Controller):
    ...
    def map_theme(self):
        theme = (
            ...
            .sudo()
            .get_param('google_map_route.theme', default='default')
        )
        res = {'theme': theme}
        return res
    ...
    def google_autocomplete_settings(self):
        ...
        is_lang_restrict = safe_eval(
            get_param(
                'google_map_route.autocomplete_lang_restrict', default='False'
            )
        )
        lang = get_param('google_map_route.lang_localization', default=False)
