...
##################################################case1
	...
	available_days = fields.Float('Balance Leaves',compute='_remaining_leave')
	...
	def _remaining_leave(self):

		for rec in self:
			rec['available_days'] =rec.employee_id.remaining_leaves
