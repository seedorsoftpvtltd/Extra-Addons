...
class PickingTransportInfo(models.Model):
    ...
    _order= 'id desc'
    _description = "Picking Transport Info"
...
# in odoo13 remove  weight_uom_id from stock.inventory
    ...
    picking_transport_info_id = fields.Many2one(
        'picking.transport.info',
        string="Reschedule Picking Transport Info",
        copy=False,
    )
