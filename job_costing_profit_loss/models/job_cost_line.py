...
#                 'customer_invoice_line_ids.invoice_id.state')
                 'customer_invoice_line_ids.move_id.state',
                 'customer_invoice_line_ids.move_id.invoice_payment_state')
...
#                if line.invoice_id.state in ['open', 'paid']:
                if line.move_id.state in ['posted'] or line.move_id.invoice_payment_state in ['paid']:
