odoo.define("ks_curved_backend_theme_seedorfinance.ks_appsmenu", function(require) {
    "use strict";
    ...
    AppsMenu.include({
        ...
        //    const hbaffinity = await this._rpc({
         //       route: "/ks_curved_theme/hbaffinity",
          //      params: { hb_icons: this._apps },

           // });
         //   this._hbaffinity = hbaffinity;

        //    const hbfinance = await this._rpc({
        //        route: "/ks_curved_theme/hbfinance",
         //       params: { hb_icons: this._apps },

         //   });
         //   this._hbfinance = hbfinance;
         ...
         //   this._hbpeople = hbpeople;
            ...
            const hbaccounting = await this._rpc({
                route: "/ks_curved_theme/hbaccounting",
                params: { hb_icons: this._apps },

            });
            this._hbaccounting = hbaccounting;
        ...
        //    for (i = 0, j = apps.length; i < j; i += chunk) {
        //        app_listaff.push(apps.slice(i, i + chunk));
        //                    console.log(app_listaff,'applisthb')
       ...
       // _finance: function() {
        ...
        //    for (i = 0, j = apps.length; i < j; i += chunk) {
        //        app_listfin.push(apps.slice(i, i + chunk));
        //                    console.log(app_listfin,'applisthb')
     ...
     //       chunk = 12;
         ...
         //   for (i = 0, j = apps.length; i < j; i += chunk) {
        //         app_listpeop.push(apps.slice(i, i + chunk));
       //                     console.log(app_listpeop,'applisthb')
     ...
     //   },
        ...
        _accounting: function() {
            ...
            for (i = 0, j = apps.length; i < j; i += chunk) {
                app_listproj.push(apps.slice(i, i + chunk));
                            console.log(app_listproj,'applisthb')
...
//        },
        ...
        _ksSearchMenusList: function() {
            ...
            this.$search_results.html(
                QWeb.render("ks_curved_backend_theme_seedorfinance.ks_search_menu_items", {
        ...
        _ksAddToFav: function(ev) {
            ...
            $(ev.currentTarget)
                .find("img")
                .attr("src", "ks_curved_backend_theme_seedorfinance/static/src/images/star.svg");
        ...
        _ksRemFromFav: function(ev) {
            ...
            $(ev.currentTarget)
                .find("img")
                .attr("src", "ks_curved_backend_theme_seedorfinance/static/src/images/fav_ic.svg");
