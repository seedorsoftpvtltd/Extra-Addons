...
odoo.define("hb_checkoutform_recaptcha.recaptcha", function(require) {
    "use strict";

    var ajax = require("web.ajax");
    var snippet_animation = require("website.content.snippets.animation");
    require("website_sale.cart");
    var websiteSaleCart = snippet_animation.registry.websiteSaleCart;

    snippet_animation.registry.websiteSaleCart = websiteSaleCart.extend({
