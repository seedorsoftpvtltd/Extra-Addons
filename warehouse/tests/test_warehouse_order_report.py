...
class TestwarehouseOrderReport(common.TransactionCase):
    def setUp(self):
        super(TestwarehouseOrderReport, self).setUp()

        self.partner_id = self.env.ref('base.res_partner_1')
        self.product1 = self.env.ref('product.product_product_8')
        self.product2 = self.env.ref('product.product_product_11')
        self.warehouseReport = self.env['warehouse.report']
    ...
    def test_00_warehouse_order_report(self):
        ...
        res_product1 = self.warehouseReport.search([
        ...
        res_product2 = self.warehouseReport.search([
