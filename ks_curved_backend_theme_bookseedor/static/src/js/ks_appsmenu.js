odoo.define("ks_curved_backend_theme_bookseedor.ks_appsmenu", function(require) {
    "use strict";
...
//        },
        ...
        _ksSearchMenusList: function() {
            ...
            this.$search_results.html(
                QWeb.render("ks_curved_backend_theme_bookseedor.ks_search_menu_items", {
        ...
        _ksAddToFav: function(ev) {
            ...
            $(ev.currentTarget)
                .find("img")
                .attr("src", "ks_curved_backend_theme_bookseedor/static/src/images/star.svg");
        ...
        _ksRemFromFav: function(ev) {
            ...
            $(ev.currentTarget)
                .find("img")
                .attr("src", "ks_curved_backend_theme_bookseedor/static/src/images/fav_ic.svg");
