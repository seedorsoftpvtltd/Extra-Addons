odoo.define('ks_curved_backend_theme_bookseedor.ControlPanel', function (require) {
"use strict";
...
odoo.define("ks_curved_backend_theme_bookseedor.AbstractController", function (require) {
  "use strict";
