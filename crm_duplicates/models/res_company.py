...
class res_company(models.Model):
    ...
    duplicate_fields_partner = fields.Many2many(
        ...
        help='Select criteria, how to search partner duplicates. Seedor would not allow to save a duplicate!',
    )
    ...
    duplicate_fields_lead = fields.Many2many(
        ...
        help='Select criteria, how to search leads duplicates. \
            Seedor would not allow to save a duplicate in comparison to the previous field',
    )
    duplicate_fields_lead_soft = fields.Many2many(
        ...
        help='Select criteria, how to search leads duplicates. \
            Seedor would show duplicates on a button, but it would allow to save a duplicate',
    )
