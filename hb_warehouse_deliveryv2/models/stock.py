...
class Warehousemoveline(models.Model):
    ...
    def create(self, vals):
        ...
        if 'production_date' in vals:
            if vals['production_date'] == '':
                vals['production_date'] = False
        vals['x_pack'] = vals
        res = super(Warehousemoveline, self).create(vals)
        return res
            ...
            if rec.picking_code == 'incoming':
                ...
                if rec.result_package_id and rec.location_dest_id == warehouses.lot_stock_id:
                    ...
                    if rec.result_package_id.location_id:
                        ...
                        if rec.result_package_id.location_id != warehouses.lot_stock_id:
