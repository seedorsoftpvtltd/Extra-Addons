...
class Warehouseinv(models.Model):
    ...
    inv_meth = fields.Selection(string="Invoice Method", selection=[('cbm', 'CBM'), ('pallet', 'Pallet'),('weight','Weight'), ('carton_units', 'Carton/Units'), ('square','Square Units')])
            ...
            if picking_id.picking_type_id.code == 'outgoing':
                ...
                for temp in picking_id.agreement_id.charge_lines:
                    temp_line_values = {
                        ...
                        # 'quantity': move_ids_without_package.x_days,
