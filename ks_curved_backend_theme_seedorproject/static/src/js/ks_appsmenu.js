odoo.define("ks_curved_backend_theme_seedorproject.ks_appsmenu", function(require) {
    "use strict";
    ...
    AppsMenu.include({
        ...
        //        route: "/ks_curved_theme/hbfinance",
         ...
         //   this._hbpeople = hbpeople;
            ...
            const hbproject = await this._rpc({
                route: "/ks_curved_theme/hbproject",
                params: { hb_icons: this._apps },

            });
            this._hbproject = hbproject;
...
//        },
        ...
        _ksSearchMenusList: function() {
            ...
            this.$search_results.html(
                QWeb.render("ks_curved_backend_theme_seedorproject.ks_search_menu_items", {
        ...
        _ksAddToFav: function(ev) {
            ...
            $(ev.currentTarget)
                .find("img")
                .attr("src", "ks_curved_backend_theme_seedorproject/static/src/images/star.svg");
        ...
        _ksRemFromFav: function(ev) {
            ...
            $(ev.currentTarget)
                .find("img")
                .attr("src", "ks_curved_backend_theme_seedorproject/static/src/images/fav_ic.svg");
