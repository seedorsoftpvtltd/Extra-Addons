odoo.define('ks_curved_backend_theme_seedorproject.ControlPanel', function (require) {
"use strict";
...
odoo.define("ks_curved_backend_theme_seedorproject.AbstractController", function (require) {
  "use strict";
