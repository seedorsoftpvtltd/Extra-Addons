        ...
        for rec in self:
            ...
            for line in rec.jobcost_line_id.account_invoice_line_ids:
                ...
                if line.move_id.invoice_date:
                    ...
                    # odoo13
                    if rec.date_from and rec.date_to and line.move_id.invoice_date >= rec.date_from and line.move_id.invoice_date <= rec.date_to and (line.move_id.state in ['posted'] or line.move_id.invoice_payment_state in ['paid']):
