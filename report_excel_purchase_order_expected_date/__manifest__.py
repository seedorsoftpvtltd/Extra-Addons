...
{
    'name': 'Purchase Order with Expected Date Confirmation (XLSX)',
    'version': '1.0.0',
    'category': 'Extra Tools',
    'summary': 'Purchase Order with Expected Date Confirmation (XLSX)',     
    'price': 0.00,
    'currency': 'EUR',
    "license": "OPL-1",     
    'description': """
...
====================================
Purchase Order with Expected Date Confirmation in MS Excel format (XLSX)
...
#     'live_test_url': "http://68.183.4.193:8069",
    ...
    'data': [
        'data/purchase_order_expected_date_xlsx.xml',
    ],
    'qweb': [
    ],
    'demo': [],
