...
class CustomerPortal(CustomerPortal):
    def _prepare_portal_layout_values(self):
        ...
        values['custom_issues_count'] = request.env['project.task'].with_context({'is_custom_bugs': True}).search_count([('custom_type', '=', 'bugs_issues')])
        return values
    ...
    def custom_portal_my_project_issues(self, page=1, date_begin=None, date_end=None, sortby=None, filterby=None, search=None, search_in='content', groupby='project', **kw):
        ...
        domain += [('custom_type', '=', 'bugs_issues')]
